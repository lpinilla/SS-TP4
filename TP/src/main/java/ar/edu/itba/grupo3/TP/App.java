...
public class App
{
    public static void main(String[] args )
    {
        ...
        //misionAMarte.findBestDayToLaunch("enero", 730, 2 * 3.154 * Math.pow(10,7));
        //guardar la rapidez de un viaje lanzado en X días por Y tiempo
        //misionAMarte.recordFlightSpeed(229, 3.154 * Math.pow(10,7));
        //guardar la velocidad (vector) de un viaje lanzado en X días por Y tiempo
        //misionAMarte.recordFlightVelocity(229, 3.154 * Math.pow(10,7));
